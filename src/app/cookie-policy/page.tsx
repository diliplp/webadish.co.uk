    ...
    <section className="section-padding">
      <div className="container">
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <p>
            Set only if you accept cookies. We use <strong>Google Tag Manager</strong> (GTM-NZLQFW58) and <strong>Google Ads</strong> (AW-18133913810) to measure the performance of our advertising campaigns. These services may set their own cookies to track conversions and retarget visitors across the web.
          </p>
          <p>
