...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Yes, if your business relies on your WordPress site. Without regular maintenance, plugins and themes become outdated and vulnerable to attack. 96% of hacked WordPress sites are running outdated software at the time of compromise. A security protection keeps your site secure, fast, and available without requiring ongoing technical attention from you.',
  },
  {
    question: 'How often should WordPress be updated?',
    answer: 'WordPress core, plugins and themes should be updated as soon as security patches are released — typically within 48-72 hours of a vulnerability being published. A managed security protection monitors for updates and applies them on schedule, often before you even know a patch exists.',
  },
  {
    question: 'What is the difference between WordPress security protection and WordPress hosting?',
    answer: 'Hosting provides the server infrastructure your site runs on. Maintenance is the ongoing technical work — updates, backups, security scanning, performance tuning — that keeps your site healthy and secure. You need both. Many protection retainers include managed hosting as part of the package.',
  },
  {
...
export default function PostPage() {
  return (
    <>
      ...
      >
        <h2>Why WordPress security protection matters for UK businesses</h2>
        ...
        <p>A professional <Link href="/wordpress-maintenance-uk">WordPress security protection</Link> removes this risk entirely, for a predictable monthly fee.</p>

        <h2>What a WordPress security protection should include</h2>
        <p>Not all protection retainers are equal. Budget services often consist of little more than automated plugin update scripts with no human oversight. Here is what a comprehensive, security-conscious security protection should actually cover:</p>

        <h3>Core, plugin and theme updates</h3>
        <p>WordPress releases security patches regularly — sometimes multiple times in a single month when critical vulnerabilities are discovered. A security protection applies these updates promptly, typically within 24–48 hours of release, before attackers can exploit newly disclosed vulnerabilities at scale.</p>
        ...
        <p>Regular automated scans check for malware, injected code, suspicious file changes, and known vulnerabilities. Good protection retainers run these scans daily and alert immediately if anything is detected — giving you the opportunity to address a problem before it affects visitors, damages SEO, or triggers a Google blacklist.</p>
        ...
        <p>When evaluating a WordPress security protection as a UK business, there are several factors that apply specifically to your context:</p>
        <ul>
        ...
        <p>The quality of WordPress security protections varies enormously. These questions will quickly separate serious providers from those running automated scripts and calling it maintenance:</p>
        <ul>
        ...
        <p>Many business owners attempt to handle WordPress security protection themselves to save money. The challenge is consistency — maintenance is not a one-time task but a continuous, recurring obligation that requires attention every week, indefinitely. A single missed security update is the vulnerability that exposes your site.</p>
